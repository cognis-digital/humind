"""Native cognis-connect emit for humind — forward findings to any platform.

Maps humind's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    humind ... --format json | humind-emit --to stix
    humind-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
